...
# model_path = f"models/MADlaplace2D{model_item}_{num_functions,num_points}.pth"  # Path to the pre-trained model
model_path = f"models/PINNlaplace2D_{num_functions,num_points}_1_1.pth"  # Another model option
