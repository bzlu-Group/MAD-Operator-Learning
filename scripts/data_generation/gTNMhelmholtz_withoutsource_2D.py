...
def generate_training_data(num_networks, num_points):
    ...
    for i in range(num_networks):
        ...
        u = torch.tensor(solve(u_b, np.zeros((num_points, num_points)), num_points, 1, k)).view(1, -1)
...
file_path = f"data/TNM{k}helmholtz_withoutsource_2D_{num_functions,num_points}.txt"  
